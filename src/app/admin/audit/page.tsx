  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-sm text-[#94A3B8] mt-0.5">Track admin actions and system events</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border border-[#E5E7EB] bg-white py-20 text-center shadow-sm">
        ...
        <p className="text-sm font-medium text-[#111827]">Audit logs coming soon</p>
        <p className="mt-1 text-xs text-[#94A3B8]">A full activity trail of all admin actions will appear here</p>
      </div>
    </div>
  );
}
