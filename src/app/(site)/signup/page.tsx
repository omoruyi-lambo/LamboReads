    ...
    >
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <h1 className="text-2xl font-bold text-[#111827]">Create your free account</h1>
          <p className="mt-1 text-sm text-[#6B7280]">
            Start your reading journey with thousands of free books.
          </p>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <Input id="name" name="name" required placeholder="Your full name" className="pl-10" />
              </div>
            </div>
